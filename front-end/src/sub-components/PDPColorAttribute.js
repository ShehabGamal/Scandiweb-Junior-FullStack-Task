...
class PDPColorAttribute extends Component {
  renderColorAttribute = () => {
    const { header, headerIndex, attributes, preferences, handleSelection } =
      this.props;
            ...
            .map((attribute) => (
              <div
                ...
                className={`preference ${
                  preferences[header] === attribute.value ? "current-color" : ""
                }`}
                style={{
...
export default PDPColorAttribute;
